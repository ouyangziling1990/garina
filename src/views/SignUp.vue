        ...
        >
          ...
          <div class="split-wrap no-bottom">
            <div class="item-wrap des">
              你的 个人信息
              被用于确保你能够安全登录并访问你的数据。出于安全性、支持和报告的目的，GarinAsset
              LLC会记录某些数据。如果你同意，GarinAsset LLC 还会使用你的 账号
              信息向你发送 营销电子邮件和交流信息（可能会基于你的
              产品使用情况）。
